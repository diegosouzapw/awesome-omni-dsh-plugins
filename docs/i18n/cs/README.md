...
<img src="../../docs/assets/readme-hero.svg" width="100%" alt="Awesome Omni DSH Plugins — katalog s prioritou pro tvůrce a instalace jedním příkazem pro pluginy DeepSeek Harness. Fixované zdrojové commity, kreditovaní tvůrci, jeden zkontrolovaný PR na plugin. dsh-plugins.omniskill.online"/>
...
<h3>
  <a href="https://dsh-plugins.omniskill.online">Procházejte, vyhledávejte a instalujte všechny pluginy na webu →</a>
</h3>
...
<a href="README.md"><img src="../../docs/assets/flags/cz.svg" width="30" alt="Čeština (cs)" title="Čeština (cs)"></a>
...
### 👉 [**Vyhledávejte všechny pluginy, čtěte podrobnosti a kopírujte instalační příkaz na webu →**](https://dsh-plugins.omniskill.online) 👈
...
| ----------- | ---------------------------------------------------------------- | ------------------------------------------------------------------------ |
| **Web** | Vykreslený prohlížeč katalogu s vyhledáváním a řazením                 | [dsh-plugins.omniskill.online](https://dsh-plugins.omniskill.online)     |
...
| **Strojová data** | `catalog.json` + `catalog.snapshot.json` pro nástroje           | [catalog.json](https://dsh-plugins.omniskill.online/catalog.json) · [catalog.snapshot.json](https://dsh-plugins.omniskill.online/catalog.snapshot.json) |
...
Web je udržován ze soukromého zdroje. CLI se nachází zde, pod [`cli/`](../../cli), a tento repozitář nese veřejná data katalogu, schéma a zásady, které oba využívají.

## Stav katalogu

**3614 sloučených pluginů.** Každý plugin vstupuje prostřednictvím jednotlivě zkontrolovaného pull requestu, jeden po druhém, z repozitáře původního tvůrce, s fixovaným zdrojovým commitem a explicitním atributem.
...
Balíček je publikován jako `omni-dsh-plugins@1.0.1` a výše uvedený příkaz je dnes kanonickým způsobem volání; zde není hostován žádný instalační skript.

### Použití CLI dnes

Verze 1.0.1 nabízí příkazy pro zjišťování a ověřování pouze pro čtení plus instalační příkazy podmíněné souhlasem. Úplná referenční příručka příkazů, včetně příznaků, návratových kódů a brány souhlasu s vykonáváním kódu, je v [docs/CLI.md](../../docs/CLI.md).
...
**[Procházejte všechny pluginy na webu →](https://dsh-plugins.omniskill.online)**
