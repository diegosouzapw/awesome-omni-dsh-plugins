...
<a href="README.md"><img src="../../docs/assets/flags/hu.svg" width="30" alt="Magyar (hu)" title="Magyar (hu)"></a>
...
A weboldalt privát forrásból tartják karban. A CLI itt, ebben a repository-ban található, a
[`cli/`](../../cli) alatt, és ez a repository hordozza a nyilvános katalógusadatokat, sémát és
szabályzatokat, amelyeket mindketten fogyasztanak.

## A katalógus állapota

**1904 bővítmény egyesítve.** Minden bővítmény egy egyedileg átvizsgált pull requesten keresztül
...
A csomag `omni-dsh-plugins@1.0.1` néven van publikálva, és a fenti parancs a
ma érvényes kanonikus meghívási mód; itt nincs telepítő szkript hosztolva.

### Használd a CLI-t már ma

Az 1.0.1-es verzió csak olvasható felfedező és validáló parancsokat kínál, valamint
