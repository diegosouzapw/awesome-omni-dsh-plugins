...
<img src="../../docs/assets/readme-hero.svg" width="100%" alt="Awesome Omni DSH Plugins — katalog yang mengutamakan kreator dan instalasi satu perintah untuk plugin DeepSeek Harness. Commit sumber yang dipatok, kreator yang diberi kredit, satu PR yang ditinjau per plugin. dsh-plugins.omniskill.online"/>
...
<h3>
  <a href="https://dsh-plugins.omniskill.online">Jelajahi, cari, dan instal setiap plugin di situs web →</a>
</h3>
...
<a href="README.md"><img src="../../docs/assets/flags/id.svg" width="30" alt="Bahasa Indonesia (id)" title="Bahasa Indonesia (id)"></a>
...
### 👉 [**Cari semua plugin, baca detailnya, dan salin perintah instalasi di situs web →**](https://dsh-plugins.omniskill.online) 👈
...
| ----------- | ---------------------------------------------------------------- | ------------------------------------------------------------------------ |
| **Situs web** | Peramban katalog yang dirender lengkap dengan pencarian dan peringkat                 | [dsh-plugins.omniskill.online](https://dsh-plugins.omniskill.online)     |
...
| **Feed mesin** | `catalog.json` + `catalog.snapshot.json` untuk alat bantu           | [catalog.json](https://dsh-plugins.omniskill.online/catalog.json) · [catalog.snapshot.json](https://dsh-plugins.omniskill.online/catalog.snapshot.json) |
...
**3614 plugin tergabung.** Setiap plugin masuk melalui satu pull request yang ditinjau secara
...
**[Jelajahi semua plugin di situs web →](https://dsh-plugins.omniskill.online)**
