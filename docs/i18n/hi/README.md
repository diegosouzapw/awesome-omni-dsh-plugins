...
**1904 प्लगइन मर्ज किए गए।** हर प्लगइन एक-एक करके, मूल निर्माता की रिपॉज़िटरी से, एक पिन किए गए सोर्स कमिट और स्पष्ट श्रेय
...
`--allow-code-execution` पास न करें। नेटिव Windows पर ये म्यूटेशन v1.0.1 में अक्षम हैं; WSL का उपयोग करें। रीड-ओनली और
...
| [docs/CLI.md](../../docs/CLI.md)                   | `omni-dsh-plugins@1.0.1` के लिए CLI कमांड संदर्भ          |
